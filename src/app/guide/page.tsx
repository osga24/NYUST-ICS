  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          雲科大課表轉換工具是一個幫助雲科大學生將 DOCX 格式的課表轉換為 ICS
          行事曆文件或 Excel 表格的在線工具。通過這個工具，你可以：
        </p>
        <ul
          style={{
            paddingLeft: "1.5rem",
        ...
        >
          <li style={{ marginBottom: "0.5rem" }}>
            上傳雲科大課表 DOCX 文件並自動識別課程資訊
          </li>
          <li style={{ marginBottom: "0.5rem" }}>預覽識別後的課表內容</li>
          <li style={{ marginBottom: "0.5rem" }}>
            將課表匯出為 ICS 格式，便於導入到 Google 日曆、Outlook 或 Apple 日曆
          </li>
        </ul>
      ...
      >
        ...
        >
          <li style={{ marginBottom: "0.5rem" }}>
            瀏覽器（Chrome、Firefox、Safari、Edge 等最新版本）
          </li>
          <li style={{ marginBottom: "0.5rem" }}>
            雲科大課表 DOCX 文件（單一系統登入你的帳號 ➡️ 課程資訊 ➡️
            學期選課資料➡️ 下載該學期課表）
          </li>
          <li style={{ marginBottom: "0.5rem" }}>
            一顆耐心的心，本工具目前只針對學期開始到學期結束做處理，國定假日還是會按照排程，如果需要的話需自行刪除行程
          </li>
          <p style={{ marginBottom: "0.5rem" }} className="text-gray-500">
            （原意是希望能提醒各位做可能需要做的作業，絕對不是我懶沒處理qq）
          </p>
        </ul>
        <div
          style={{
      ...
      >
        ...
        >
          ...
          <li style={{ marginBottom: "1rem" }}>
            ...
            <p style={{ color: yuntechTheme.gray[600], margin: 0 }}>
              根據需求點擊「匯出 ICS 行事曆」或「匯出
              Excel」按鈕，將課表轉換為對應格式並下載。
            </p>
          </li>
        </ol>
        <div
      ...
      >
        ...
        >
          ICS 是一種行事曆檔案格式，可導入到大多數行事曆應用中，包括 Google
          日曆、Outlook 和 Apple 日曆。
        </p>
        <p
          style={{
            marginBottom: "0.5rem",
          ...
          <li style={{ marginBottom: "1rem" }}>
            ...
            >
              ...
              <p className="text-gray-500">
                （因為我沒過 Outlook 所以這段是 AI 生的，如果流程有誤歡迎到
                github 發 issue 或
                <a
                  href="https://osga.dev/contact"
        ...
        >
          <div style={{ display: "flex" }}>
            ...
            <div style={{ marginLeft: "0.75rem" }}>
              ...
              >
                ICS
                文件包含了課程名稱、時間、地點等資訊，並設置了重複規則，會在整個學期內按周重複。系統也會自動設置提醒，讓您不會錯過任何一堂課！
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          除了 ICS 行事曆，您還可以將課表匯出為 Excel 格式。Excel
          格式便於您進一步編輯和處理課表資料。
        </p>
        <p
          style={{
        ...
        <p style={{ color: yuntechTheme.gray[700], lineHeight: 1.6 }}>
          匯出的 Excel 文件可使用 Microsoft Excel、Google 試算表、LibreOffice
          Calc 等電子表格軟體打開。
        </p>
      </motion.section>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          <div>
            ...
            >
              A:
              系統會嘗試識別標準格式的課表，但如果您的課表格式特殊或有手動修改，可能會導致識別錯誤。請確保上傳的是從單一下載的原始課表。
            </p>
          </div>
          ...
          <div>
            ...
            >
              A:
              目前系統不支持直接編輯識別後的課程資訊。如需編輯，建議嘗試按照原
              DOCX 的檔案進行編輯，並且嘗試系統是否可以讀取課程。
            </p>
          </div>
          ...
          <div>
            ...
            >
              A:
              在課表識別成功後，頁面會顯示學期設置區域，目前是由系統預設雲科本學期的開始時間以及結束時間，會在每次學期結束後手動更新，如果沒有的話請提醒我🥲。
            </p>
          </div>
          ...
          <div>
            ...
            >
              A:
              目前系統僅根據課表生成課程行事曆，不包含假期或特殊日期。需要自行將假日手動移除，日後（可能）會更新，如果想一同協作，歡迎
              <a
                href="https://osga.dev/contact"
                className="text-teal-600 hover:text-teal-700"
              >
          ...
          <div>
            ...
            >
              A:
              不會。本工具完全在您的瀏覽器中運行，所有文件處理都在本地設備上進行，不會將資料上傳到任何伺服器。
            </p>
          </div>
